...
async def me(user: dict = Depends(get_current_user)):
    ...
    # Backfill: usuarios antiguos (creados antes del sistema de referidos)
    # pueden venir sin referral_code. Lo generamos una vez y lo persistimos.
    if not user.get("referral_code"):
        ...
        for _ in range(20):
            ...
            res = await db.users.update_one(
                {"_id": user["_id"], "referral_code": {"$in": [None, ""]}},
