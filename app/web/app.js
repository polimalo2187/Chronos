...
// API base: por defecto usa el mismo origen ("" = relativo).
// Si estás abriendo la UI en un dominio y la API en otro, puedes forzarlo con:
// 1) query param ?api=https://tu-api.com  (se guarda en localStorage)
// 2) localStorage key: chronos_api_base
const API_BASE_KEY = "chronos_api_base";
